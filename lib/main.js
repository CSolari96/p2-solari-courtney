...
// Donate Menu
var donateMenu = document.getElementById("slideout"); // Store donation slideout menu
var openDonateMenu = document.getElementById("open-donate"); // Store open donate menu button
var closeDonateMenu = document.getElementById("close-donate"); // Store close donate menu button
